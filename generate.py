...
def main():
    print('== Generating Mandarin.lark')

    print('  -- [0/6] Reading Mandarin.lark.in')
    ...
    print('  -- [4/6] Generating operators rule')
    operators = []
    try:
